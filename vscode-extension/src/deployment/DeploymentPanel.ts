...
import { DeploymentManager, DeploymentPlatform, DeploymentStatus } from './DeploymentManager';
 ...
 * - Build settings
 */
export class DeploymentPanel implements vscode.Disposable {
   ...
   */
  private async handleDeploy(platform: DeploymentPlatform): Promise<void> {
   ...
   */
  private async handleConfigureToken(platform: DeploymentPlatform): Promise<void> {
