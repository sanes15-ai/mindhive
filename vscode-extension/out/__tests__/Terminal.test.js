...
const CommandTranslator_1 = require("../terminal/CommandTranslator");
...
suite('Terminal Integration Test Suite', () => {
    ...
    setup(() => {
        ...
        const mockAuthManager = new AuthManager_1.AuthManager(mockContext);
        mockClient = new HiveMindClient_1.MindHiveClient(mockContext, mockAuthManager);
        translator = new CommandTranslator_1.CommandTranslator(mockClient);
    });
